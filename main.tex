...
\bibliographystyle{bib/jneurosci}
...
% Glossário (gerado automaticamente - veja entradas em tex/00-introducao/introducao.tex e em tex/02-estilo/estilo.tex)
\cleardoublepage
...
% Cap. 2 - Objetivos
\include{tex/02-objetivos/objetivos}

% Cap. 3 - Metodos
\include{tex/03-metodos/metodos}

% Cap. 4 - Resultados
\include{tex/04-resultados/resultados}

% Cap. 5 - Conclusao
\include{tex/05-conclusao/conclusao}

% Cap. 6 - Ideias
\include{tex/06-ideias/ideias}

% Cap. 7 - Cronograma
\include{tex/07-cronograma/cronograma}
